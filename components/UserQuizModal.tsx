...
interface UserQuizModalProps {
  onClose: () => void
  onComplete: (goals: MacroGoals) => void
}
...
const UserQuizModal: React.FC<UserQuizModalProps> = ({ onClose, onComplete }) => {
  ...
  const handleNext = async () => {
    if (step === 10) {
      ...
      setIsLoading(true)
      try {
        const userId = "local-user" // Use a consistent local user ID
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-orange-900/20 to-slate-900 flex items-center justify-center z-50 p-4 h-screen w-screen overflow-hidden">
      ...
      <div
        className={`relative bg-white/95 backdrop-blur-xl rounded-2xl p-8 w-full max-w-lg shadow-2xl border border-white/20 animate-${direction === "left" ? "slide-left" : "slide-right"} transition-transform duration-300`}
      >
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Personalize your nutrition plan</p>
          </div>
          <button
            onClick={handleSkip}
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-sm font-bold text-orange-600">{step}/10</span>
          </div>
        ...
        <div className="space-y-6 min-h-[300px]">
          {step === 1 && (
            <div className="space-y-4 animate-fade-in">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">What is your gender?</h3>
          ...
          {step === 2 && (
            <div className="space-y-4 animate-fade-in">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">How old are you?</h3>
                <input
                  type="number"
                  value={quizData.age || ""}
          ...
          {step === 3 && (
            <div className="space-y-4 animate-fade-in">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">What's your weight? (kg)</h3>
                <input
                  type="number"
                  step="0.1"
          ...
          {step === 4 && (
            <div className="space-y-4 animate-fade-in">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-4">What's your height? (cm)</h3>
                <input
                  type="number"
          ...
          {step === 5 && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">What's your dietary preference?</h3>
              <div className="space-y-3">
                {[
          ...
          {step === 6 && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">What's your activity level?</h3>
              <div className="space-y-3">
                {[
          ...
          {step === 7 && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Your BMI</h3>
              <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 p-6 rounded-xl border-2 border-orange-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-700 font-semibold mt-2">Body Mass Index</p>
                  <p className="text-gray-600 text-sm mt-3">
                    {bmiSuggestion === "gain" && "📈 Consider gaining weight for optimal health"}
                    {bmiSuggestion === "maintain" && "✅ Your BMI is in a healthy range"}
                    {bmiSuggestion === "lose" && "📉 Consider losing weight for optimal health"}
                  </p>
                </div>
              </div>
            </div>
          ...
          {step === 8 && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">What's your goal?</h3>
              <div className="space-y-3">
                {[
          ...
          {step === 9 && quizData.goal !== "maintain" && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Intensity of your goal?</h3>
              <div className="space-y-3">
                {[
                  { value: "mild", label: "Mild (~0.5 lb/week)", icon: "🐢" },
                  { value: "moderate", label: "Moderate (~1 lb/week)", icon: "🚴" },
                  { value: "aggressive", label: "Aggressive (~1.5 lb/week)", icon: "🚀" },
                ].map((intensity) => (
                  <OptionButton
                    key={intensity.value}
          ...
          {step === 9 && quizData.goal === "maintain" && (
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-6 rounded-xl border-2 border-blue-200">
                <p className="text-gray-700 font-semibold">⚖️ You chose to maintain your weight</p>
                <p className="text-gray-600 text-sm mt-2">
                  No intensity selection needed. Let's see your daily goals next!
                </p>
              </div>
            </div>
          )}
          ...
          {step === 10 && (
            <div className="space-y-4 animate-fade-in">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Your daily goals</h3>
              <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 p-6 rounded-xl border-2 border-orange-200">
                <p className="text-gray-700 font-semibold mb-4">Based on your profile:</p>
          ...
          <div className="flex gap-3 pt-4">
            ...
            {(step === 2 || step === 3 || step === 4) && (
              <button
                onClick={handleNext}
                disabled={isLoading || !quizData[step === 2 ? "age" : step === 3 ? "weight" : "height"]}
